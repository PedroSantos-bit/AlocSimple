...
public class Pessoa {
	...
	public String getFormatoContrato(){ //aqui a dúvida.
		return contrato.formatoContrato;
	}
	
	public String toString() {
		return "APARTAMENTO " + apartamento.numeroApartamento + ": "  + this.nome + "  |  " + this.idade + " anos  |  " + this.status + "(A)  |  " + this.rg	+"  |  " + this.contrato.getDataAlocacao()
